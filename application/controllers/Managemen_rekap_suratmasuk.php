...
class Managemen_rekap_suratmasuk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('panel/rekap_agenda_surat_masuk', $data);
        $this->load->view('templates/footer');
    }

    public function cetak_rekap_srt_masuk()
    {
        ...
        $file_pdf = 'rekap_surat_masuk';
        // setting paper
        $paper = 'A4';
        //orientasi paper potrait / landscape
        $orientation = "portrait";
        $data['title_pdf'] = 'Rekap Surat Masuk';
        ...
        if (empty($tanggal_awal) or empty($tanggal_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
            $transaksi = $this->Model_rekap_suratmasuk->view_all();  // Panggil fungsi view_all yang ada di TransaksiModel
            $label = 'Semua Data Transaksi';
        } else { // Jika terisi
            $transaksi = $this->Model_rekap_suratmasuk->view_by_date($tanggal_awal, $tanggal_akhir);  // Panggil fungsi view_by_date yang ada di TransaksiModel
        ...
        $html = $this->load->view('laporan_rekap_suratmasuk', $data, true);
