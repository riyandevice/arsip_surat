...
class Model_rekap_suratmasuk extends CI_model
{
    ...
    public function view_all()
    {
        ...
        return $this->db->get('tbl_surat_masuk')->result(); // Tampilkan semua data transaksi
    }
    ...
    public function view_by_date($tanggal_awal, $tanggal_akhir)
    {
        ...
        $this->db->order_by('no_agenda ASC', 'nama ASC');
        return $this->db->get('tbl_surat_masuk')->result(); // Tampilkan data transaksi sesuai tanggal yang diinput oleh user pada filter
    }
}
