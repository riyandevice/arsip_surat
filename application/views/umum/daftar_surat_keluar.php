...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> Daftar<small> Surat Keluar</small></h1>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h5 class="card-title m-0"><i class="far fa-envelope"></i> Daftar Surat Keluar</h5>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($dtl->file != NULL || $dtl->file != "") { ?>
                                                            <a href="<?php echo base_url(); ?>uploads/surat_keluar/<?php echo $dtl->file; ?>" target="_blank">
